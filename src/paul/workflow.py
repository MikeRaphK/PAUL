...
def parse_paul_response(chat_history: List[BaseMessage], token_logger: OpenAICallbackHandler, issue_number: Optional[int] = None) -> Dict[str, str]:
    """
...
def run_paul_workflow(*, repo_path: str, issue_body: str, OPENAI_API_KEY: str, issue_title: Optional[str] = None, issue_number: Optional[int] = None, model: str = "gpt-4o-mini") -> Dict[str, str]:
    """
    ...
    SYSTEM_MESSAGE_PATH = os.path.join(START_DIR, "src/paul/resources/system_message.txt")
    os.chdir(repo_path)
